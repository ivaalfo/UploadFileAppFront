...
@Component({
  selector: 'm-trackFilter-input',
  templateUrl: './trackFilter-input.component.html',
  styleUrls: ['./trackFilter-input.component.scss']
})
export class TrackFilterInputComponent {
  ...
  public ngOnInit(): void {
    const filtroGuardado = sessionStorage.getItem('filteredTR');
    if (filtroGuardado) {
  ...
  public submit(): void {
    ...
    //Si tiene contenido válido (3 o más caracteres), filtramos
      ...
      sessionStorage.setItem('filteredTR', this.search);
