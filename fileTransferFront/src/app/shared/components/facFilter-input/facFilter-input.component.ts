...
@Component({
  selector: 'm-facFilter-input',
  templateUrl: './facFilter-input.component.html',
  styleUrls: ['./facFilter-input.component.scss']
})
export class FacFilterInputComponent {
  ...
  public ngOnInit(): void {
    const filtroGuardado = sessionStorage.getItem('filteredFAC');
    if (filtroGuardado) {
  ...
  public submit(): void {
    ...
    //Si tiene contenido válido (3 o más caracteres), filtramos
      ...
      sessionStorage.setItem('filteredFAC', this.search);
