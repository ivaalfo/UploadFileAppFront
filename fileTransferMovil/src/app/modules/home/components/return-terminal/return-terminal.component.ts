...
@Component({
  selector: 'm-return-terminal',
  templateUrl: './return-terminal.component.html',
  styleUrls: ['../task.component.scss']
})
export class ReturnTerminalComponent extends BaseComponent implements OnInit, OnDestroy {
  ...
  protected onConfirmed(): void {
    ...
    if (this.selectedLicensePlate && this.transport) {
      this.actionSubscription = this.actionService.terminalReturn(this.transport)
        .pipe(
          take(1),
          finalize(() => {
            if (result) {
