...
@Component({
  selector: 'm-container-empty',
  templateUrl: './container-empty.component.html',
  styleUrls: ['../task.component.scss']
})
export class ContainerEmptyComponent extends BaseComponent implements OnInit, OnDestroy {
  ...
  protected onConfirmed(): void {
    ...
    if (this.selectedLicensePlate && this.transport) {
      this.actionSubscription = this.actionService.emptyReturn(this.transport)
        .pipe(
          take(1),
          finalize(() => {
            if (result) {
